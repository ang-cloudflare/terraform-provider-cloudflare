...
* **dns_record:** improve dns sweepers ([#6430](https://github.com/cloudflare/terraform-provider-cloudflare/issues/6430)) ([b0cdcbb](https://github.com/cloudflare/terraform-provider-cloudflare/commit/b0cdcbb2a30fe5297d16ec11548656677097e0ff))
...
* improved email routing sweepers ([#6429](https://github.com/cloudflare/terraform-provider-cloudflare/issues/6429)) ([bceb012](https://github.com/cloudflare/terraform-provider-cloudflare/commit/bceb012ebc61d58b96780f2f2283dbe967d05a3a))
...
* v4 to v5 migration for zero_trust_gateway_policy ([#6413](https://github.com/cloudflare/terraform-provider-cloudflare/issues/6413)) ([d055ba1](https://github.com/cloudflare/terraform-provider-cloudflare/commit/d055ba14cfadcac2c1a83de132821efdaac718cf))
* v4 to v5 migration tests for workers_kv_namespace ([#6424](https://github.com/cloudflare/terraform-provider-cloudflare/issues/6424)) ([137ab9b](https://github.com/cloudflare/terraform-provider-cloudflare/commit/137ab9bd32fbd9a56431e807c46c25ad77d76ecc))
* v4 to v5 migration tests for zero trust list records ([#6400](https://github.com/cloudflare/terraform-provider-cloudflare/issues/6400)) ([5af5b58](https://github.com/cloudflare/terraform-provider-cloudflare/commit/5af5b5842cac4b5a53db6d6444bc99a4234bc0eb))
...
* **account_member:** Add migration test ([#6425](https://github.com/cloudflare/terraform-provider-cloudflare/issues/6425)) ([6d72a77](https://github.com/cloudflare/terraform-provider-cloudflare/commit/6d72a77efeeb320bdc3db5c5b0b3d28012acdbef))
* **api:** update composite API spec ([7fab456](https://github.com/cloudflare/terraform-provider-cloudflare/commit/7fab4568dbea1597d78d6e84452c2fe5c3afa37d))
* **api:** update composite API spec ([68ae9d9](https://github.com/cloudflare/terraform-provider-cloudflare/commit/68ae9d94bdfdb2a18513c7bab7cf2f34723e8036))
* **api:** update composite API spec ([490606b](https://github.com/cloudflare/terraform-provider-cloudflare/commit/490606ba7567fd4d3c0d1474c544a12fb6d5f95c))
* **api:** update composite API spec ([e217b50](https://github.com/cloudflare/terraform-provider-cloudflare/commit/e217b50f5b463c764ec0f2ce458926fd8ee8180b))
* **api:** update composite API spec ([30d8990](https://github.com/cloudflare/terraform-provider-cloudflare/commit/30d89902a0a8833e365b1e94c332b49fc4897c19))
* **api:** update composite API spec ([f41f147](https://github.com/cloudflare/terraform-provider-cloudflare/commit/f41f1475d792ac7aaec127ef3224d982a9f50c2e))
* **api:** update composite API spec ([cc01a10](https://github.com/cloudflare/terraform-provider-cloudflare/commit/cc01a10ed3bf891e06971f1f23c4e18cc6f4cd86))
* **api:** update composite API spec ([f10f853](https://github.com/cloudflare/terraform-provider-cloudflare/commit/f10f8533485ad270c44d7a45cdee36ad95631220))
* **api:** update composite API spec ([a033c94](https://github.com/cloudflare/terraform-provider-cloudflare/commit/a033c94794c0969aeb901b904acf0066ed3047af))
* **api:** update composite API spec ([d84ee2d](https://github.com/cloudflare/terraform-provider-cloudflare/commit/d84ee2d943abbb958b7fc58cc35e74279ab87c74))
* **api:** update composite API spec ([f13a6b2](https://github.com/cloudflare/terraform-provider-cloudflare/commit/f13a6b29b472e7ee96c4a5ae2790b525aacac1fe))
...
* **internal:** codegen related update ([5e8c3ee](https://github.com/cloudflare/terraform-provider-cloudflare/commit/5e8c3eef59aa6026b4c84c613cff20079c1cf674))
* **internal:** codegen related update ([eed065c](https://github.com/cloudflare/terraform-provider-cloudflare/commit/eed065c11a1463451fb129425cb4268f93097fd4))
...
* **sso_connector:** Add acceptance tests ([#6427](https://github.com/cloudflare/terraform-provider-cloudflare/issues/6427)) ([a279968](https://github.com/cloudflare/terraform-provider-cloudflare/commit/a27996822b9026ef7589ebbc58149451da4d9cd5))
